...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-ttia-black border-t border-ttia-cream/5 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-ttia-cream/60">
              <li><a href="#about" className="hover:text-ttia-red transition-colors">About Us</a></li>
              <li><a href="#careers" className="hover:text-ttia-red transition-colors">Careers</a></li>
              <li><a href="#privacy" className="hover:text-ttia-red transition-colors">Privacy Policy</a></li>
               <li><a href="#privacy" className="hover:text-ttia-red transition-colors">DCA MEMBERS -- AND OEIAC </a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-ttia-cream/60">
              <li><a href="#services" className="hover:text-ttia-red transition-colors">MCP Servers</a></li>
              <li><a href="#services" className="hover:text-ttia-red transition-colors">Consulting</a></li>
              <li><a href="#services" className="hover:text-ttia-red transition-colors">Integrations</a></li>
            </ul>
          </div>
